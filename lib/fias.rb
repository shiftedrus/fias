...
Fias.configure do |config|
  ...
  config.add_name('садовое неком-е товарищество', 'снт', ['садоводство', 'тер. снт'])
  ...
  config.add_name('гаражно-строительный кооператив', 'гск', ['тер. гск'])
  ...
  config.add_name('товарищества собственников недвижимости', 'тер. тсн')
  config.add_name('дачных некоммерческих товариществ', 'тер. днт')
